 ...
 * @author Anjana
 */
public class Material_Registation extends javax.swing.JDialog {

    Product_registation pr;

    public Material_Registation(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadMaterial();
    ...
    public Material_Registation(Product_registation parent, boolean modal) {
        this.pr = parent;
        initComponents();
        loadMaterial();
...
//        String c_id = jTable1.getValueAt(selectRow, 0).toString();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Material_Registation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Material_Registation dialog = new Material_Registation(new javax.swing.JFrame(), true);
